...
import 'package:baba/ViewModel/get_most_trending_products_viewmodel.dart';
...
var todayOfferImages = [Assets.MostTrending,Assets.TrendingBG1,Assets.TrendingBG2,Assets.TrendingBG3];
Widget mostTrendingGrid(){
  return GetBuilder<GetMostTrendingProductsViewModel>( // specify type as Controller
    init: GetMostTrendingProductsViewModel(), // intialize with the Controller
